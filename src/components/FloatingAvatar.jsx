...
const BASE = import.meta.env.BASE_URL; // resolves to "/Portfolio/" on Pages
    ...
    <div className="fixed bottom-8 right-0 z-50 pr-1 sm:pr-2 select-none">
      ...
      >
        ...
        <motion.button
          ...
          initial={false}
          animate={{ x: open ? 0 : 22 }}  // adjust to peek more/less
          transition={{ type: "spring", stiffness: 220, damping: 18 }}
        >
          <img
            src={`${BASE}converted_1.png`}  // file in /public
            alt="Avatar head"
        ...
        <AnimatePresence>
          {open && (
            ...
            >
              ...
              >
                <img
                  src={`${BASE}converted_2.png`}  // file in /public
                  alt="Avatar open"
